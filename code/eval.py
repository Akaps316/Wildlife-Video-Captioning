...
if __name__ == '__main__':
    ...
    parser.add_argument('--recover_opt', type=str,
                        help='recover train opts from saved opt_json',default='save/opt_info.json')
    parser.add_argument('--model_path', type=str,
                        help='path to saved model', default='save/model_90.pth')
