...
def parse_opt():
    ...
    parser.add_argument(
        '--output_dir', type=str, help='output directory of npy', default='op/'
    )
    parser.add_argument(
        '--video_dir', type=str, help='training videos directory', default='videos/'
    )
    parser.add_argument(
