...
def main():
    video_path = input('Enter the path to the video in single inverted commas')
    #video_path = '../test/b.mp4'
    # model_path = input('enter the model path in single inverted commas: ')
    model_path = 'save/model_90.pth'
    ...
    model = MultimodalAtt(185, 28, 1024, 512, rnn_dropout_p=0)
    model = model.cuda()
    model = nn.DataParallel(model)
